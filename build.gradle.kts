...
dependencies {
    ...
    api("com.github.simplified-dev:collections") { version { strictly("c2d6b6c") } }
    api("com.github.simplified-dev:utils") { version { strictly("3f20b02") } }
    api("com.github.simplified-dev:image") { version { strictly("bec9b70") } }
